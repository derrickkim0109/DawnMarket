...
struct AppDisplayClassDTOObjectMother {
    static func getListResultAppDisplayClassInfoResponseDTOWithCompleteData() -> ListResultAppDisplayClassInfoResponseDTO {
        return ListResultAppDisplayClassInfoResponseDTO(data: getAppDisplayClassInfoResponseDTOListWithCompleteData(), message: "")
    }
    ...
    static func getAppDisplayClassInfoResponseDTOListWithCompleteData(count: Int = 20) -> [AppDisplayClassInfoResponseDTO] {
